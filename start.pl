:-([matrice,agenti,oneDirection,rosa_dei_venti]).
...
start :- 
	...
	insert_theOneAndTarget(Matrix,NeoEnv),%inserisci Neo nell'ambiente e il target/telefono con cui uscire da Matrix
